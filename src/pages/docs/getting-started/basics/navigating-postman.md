...
<img alt="Postman app" src="https://assets.postman.com/postman-docs/v10/navigating-postman-v10-4.jpg"/> <!-- TODO: update screenshot with Postman Vault in footer -->
...
<!-- * <img alt="Vault icon" src="https://assets.postman.com/postman-docs/icons/icon-vault.jpg#icon" width="12px"> **Vault** - Store secrets locally as vault variables in your [Postman vault](/docs/sending-requests/postman-vault-variables/). -->
