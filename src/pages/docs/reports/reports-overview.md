...
> [__Reports are available on all Postman Enterprise plans. The Public API Network report is available on all Postman plans.__](https://www.postman.com/pricing)
